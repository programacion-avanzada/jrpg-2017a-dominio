...
public class Test_PotenciarAtributosConItems {

	@Test
	public void test_Bonificaciones(){
		...
		Assert.assertTrue(h.getSalud_tope()==105);
		
		h.equiparItem(botasDeExplorador);
		Assert.assertTrue(h.getEnergia_tope()==105);
}
	
	@Test
	public void test_AlDesequiparPerderBonificacion(){
	...
	@Test
	public void test_NoEquipar3ItemsDeManos(){
		Humano h = new Humano("Nicolas",new Guerrero(),1);
		ItemDeManos ragnarok = new ItemDeManos(1, 10, "ragnarok", "Manos", 50, 0, 0, 0, 0, 10, 10, 10);
		ItemDeManos excalibur = new ItemDeManos(1, 10, "excalibur", "Manos", 50, 0, 0, 0, 0, 10, 10, 10);
	...
	@Test
	public void test_NoEquiparMasDe2ItemsDelMismoTipo(){
		Humano h = new Humano("Nicolas",new Guerrero(),1);
